...
backup = db_path.with_suffix(db_path.suffix + ".backup-v68")
...
if "point_pin_hash" not in cols:
    cur.execute("ALTER TABLE employee ADD COLUMN point_pin_hash VARCHAR(255)")
con.commit()
con.close()

print("Migração V6.8 concluída.")
print("IMPORTANTE: para colaboradores já cadastrados, o RH deve definir a senha de ponto no perfil individual.")
